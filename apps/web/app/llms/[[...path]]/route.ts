...
Current version: 0.24.3. Requires bun >=1.1. Published as \`@s0nderlabs/anima\` on npm; binary name is \`anima\`.
...
Current version: 0.24.3. Binary name: \`anima\`. Engine: bun >=1.1.`
