...
Current version: 0.21.20. Requires bun >=1.1. Published as \`@s0nderlabs/anima\` on npm; binary name is \`anima\`.
...
Current version: 0.21.20. Binary name: \`anima\`. Engine: bun >=1.1.`
